...
ActiveRecord::Schema.define(version: 20170914160703) do
  ...
  create_table "machines", force: :cascade do |t|
    t.string "location"
    t.bigint "owner_id"
    t.bigint "snack_machine_id"
    t.index ["owner_id"], name: "index_machines_on_owner_id"
    t.index ["snack_machine_id"], name: "index_machines_on_snack_machine_id"
  end
  ...
  create_table "snacks", force: :cascade do |t|
    ...
    t.bigint "snack_machine_id"
    t.index ["snack_machine_id"], name: "index_snacks_on_snack_machine_id"
  end

  add_foreign_key "machines", "owners"
  add_foreign_key "machines", "snack_machines"
  add_foreign_key "snack_machines", "machines"
  add_foreign_key "snack_machines", "snacks"
  add_foreign_key "snacks", "snack_machines"
end
